...
class TwitterOAuth extends Config
{
	...
	public function getRetrievImage($url)
    {	
        return $this->oAuthRequest($url, 'GET', array(), false);
    }
	...
	private function oAuthRequestRetrievImage($url, $method )
    {	
		$parameters = array();
		$json = false;
        $request = Request::fromConsumerAndToken($this->consumer, $this->token, $method, $url, $parameters, $json);
        ...
        return $this->requestRetrievImage($request->getNormalizedHttpUrl(), $method, $authorization, $parameters, $json);
